...
data class FwConfig(
    ...
    class Builder {
        ...
        // region 高级侵入性策略
        var enableLockScreenActivity: Boolean = true // 默认关闭
        var enableFloatWindow: Boolean = true        // 默认关闭
        var floatWindowHidden: Boolean = true
        // endregion

        // region 无法强制停止策略
        var enableForceStopResistance: Boolean = true // 默认关闭（侵入性强，仅 Android 5.0-9.0 有效）
        // endregion
